...
export default class NewRecordComponent extends React.Component {
    ...
    handleSubmit(event) {
      ...
      var jsonPostBody = {'sku': this.state.sku, 'name':this.state.name, 'description':this.state.description}
    ...
    render() {
      return (
        <form onSubmit={this.handleSubmit}>
          ...
          <label>
            SKU:
            <input type="text" value={this.state.sku} onChange={this.handleChangeSku} />
          </label>
          <label>
            Name:
